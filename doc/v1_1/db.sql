...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='魔法袋表（临期食物盲盒）';
...
CREATE TABLE `merchants` (
                             ...
                             `score` decimal(2,1) NOT NULL DEFAULT '0.0' COMMENT '商铺评分',
                             ...
                             UNIQUE KEY `merchants_unique` (`user_id`),
                             KEY `merchants_status_IDX` (`status`) USING BTREE,
                             KEY `merchants_longitude_IDX` (`longitude`,`latitude`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商家表';
...
CREATE TABLE `users` (
                         ...
                         `role` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色：user，merchant，admin',
                         `phone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '手机号（唯一）',
                         `status` tinyint NOT NULL DEFAULT '0' COMMENT '0-Not activated; 1-Activated',
                         ...
                         UNIQUE KEY `phone` (`phone`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户表（消费者）';


-- railway.carts definition
...
-- railway.cart_items definition

CREATE TABLE `cart_items` (
                              `item_id` bigint NOT NULL AUTO_INCREMENT,
                              `cart_id` bigint NOT NULL,
                              `magic_bag_id` bigint NOT NULL,
                              `quantity` int NOT NULL DEFAULT '1',
                              `added_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                              `status` varchar(20) NOT NULL DEFAULT 'in_cart',
                              PRIMARY KEY (`item_id`),
                              KEY `fk_cart_items_cart` (`cart_id`),
                              KEY `fk_cart_items_magic_bag` (`magic_bag_id`),
                              CONSTRAINT `fk_cart_items_cart` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`cart_id`) ON DELETE CASCADE,
                              CONSTRAINT `fk_cart_items_magic_bag` FOREIGN KEY (`magic_bag_id`) REFERENCES `magic_bags` (`id`)
