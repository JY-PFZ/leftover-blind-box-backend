...
public class MerchantRegisterDto {
    ...
    @Schema(description = "商家名称", example = "美味餐厅", required = true)
    private String name;
    
    @Pattern(regexp = "^1[3-9]\\d{9}$", message = "手机号格式不正确")
    @Schema(description = "联系手机号", example = "13800138000")
    private String phone;
    
    @NotBlank(message = "地址不能为空")
    @Size(max = 255, message = "地址长度不能超过255个字符")
    @Schema(description = "详细地址", example = "Unit 1, 1000, Bedok North Street 5", required = true)
